					...
					<div class="main-header-right">
							...
							<li class="">
								<div class="dropdown nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/uk_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar mr-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/algeria_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
										...
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar  mr-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/uk_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img class="border border-4" alt="" src="{{URL::asset('assets/img/faces/6.gif')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/6.gif')}}" class=""></div>
											<div class="ml-3 my-auto">
												<h6>{{ Auth::user()->name }}</h6><span>{{ Auth::user()->plan }} Member</span>
											</div>
										</div>
									</div>
									...
									<a class="dropdown-item" href="{{ url('editUser') }}"><i class="bx bx-cog"></i> Edit Profile</a>
