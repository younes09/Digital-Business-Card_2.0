		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/showUsers') }}">
							...
							<i class="fas fa-toolbox fa-lg mr-2"></i>
							<span class="side-menu__label">Admin Pannel</span>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards2') }}">Cards2</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='contacts2') }}">Contacts2</a></li>
